...
#+HTML_HEAD: <script src="assets/bqn.js" defer></script>
...
The title of this write-up doesn't have any specific meaning; it is merely a recursive acronym that uses quantum computing jargon.
